        ...
        <div id="faq-container">
          ...
          <div>
            <Collapsible
              ...
              <p className="faq-answer">The goal of CSOP is to create a collegiate scene for poker just like any other sport. Colleges nation-wide can participate throughout each season. Players can play in 9 player Sit-N-Go (SNG) tournaments throughout the season and climb leagues/elo. At the end of each season, the top X people or top X from each school will be invited to a large, multi-day national finals tournament - on the order of 500 competitors. If live in-person is allowed, it will be in Boston or NY or something. It will also be filmed, have commentators, reward cash prizes, etc.</p>
            </Collapsible>
          </div>
          <div>
            ...
            <Collapsible
              ...
              triggerOpenedClassName="faq-title active"
              contentInnerClassName="faq-content">
              <p className="faq-answer">First season will be in Fall 2020. The season will last from ~September to ~April/May (one school year). Each season will last a school year.</p>
            </Collapsible>
          </div>
          <div>
            ...
            <Collapsible
              ...
              triggerOpenedClassName="faq-title active"
              contentInnerClassName="faq-content">
              <p className="faq-answer">Throughout the season (~Sep to ~April/May), players will play in a series of 9 player SNG tournaments that will affect their overall rank. The ranking system is an adaptation of popular MOBA, FPS, and Battle Royale games (League of Legends, CS:GO, PUBG, etc.). There are 6 total leagues to rank players: Bronze, Silver, Gold, Platinum, Diamond, and Master. Each player in a league will have a certain amount of league points (LP) ranging from 0 to 100. </p>
              <p className="faq-answer">The goal is to gain more LP to advance to the next league (i.e. hitting 100+ LP advances to the next league like Bronze to Silver). At the beginning of CSOP, we’ll probably just start with hard rankings (#1, #123, etc.) before splitting into ranks when more colleges come on board.</p>
            </Collapsible>
          </div>
          <div>
            <Collapsible
